...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 python train.py --save_name Train_10_images_t1_attention_transformer_VOC_10layers_ablation_200images --config ./config/VOC/VOC_Sematic_Seg_5Images.yaml --image_limitation 118 --batch_size 16